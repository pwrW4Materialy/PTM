...
\begin{document}
	...
	\section{Kod programu}
		\begin{minipage}{.5\textwidth}
			\lstinputlisting[firstnumber=1, firstline=1, lastline=44]{../../lab5/lab5.asm}
		\end{minipage}%	
		\begin{minipage}{.5\textwidth}
			foo
		\end{minipage}
		...
		\begin{minipage}{.5\textwidth}
			\lstinputlisting[firstnumber=45, firstline=45, lastline=98]{../../lab5/lab5.asm}
		\end{minipage}%	
		\begin{minipage}{.5\textwidth}
			foo
		\end{minipage}
		...
		\begin{minipage}{.5\textwidth}
			\lstinputlisting[firstnumber=97, firstline=98, lastline=150]{../../lab5/lab5.asm}
		\end{minipage}%	
		\begin{minipage}{.5\textwidth}
			foo
		\end{minipage}
